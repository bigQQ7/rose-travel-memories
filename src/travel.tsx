...
const trips: Step[] = [
  { date: '2021.5', title: '杭州', description: '我们第一次一起去旅行', colorTheme: 'orange' },
  { date: '2021.9', title: '成都', description: '一起走过的第二站', colorTheme: 'blue' },
  { date: '2023.6', title: '广西 · 重庆', description: '这一程，去了两个地方', colorTheme: 'purple' },
  { date: '2024.1', title: '赛里木湖', description: '第一次一起到赛里木湖', colorTheme: 'orange' },
  { date: '2025.2', title: '赛里木湖', description: '我们又一起回到这里', colorTheme: 'blue' },
];
function Travel() {
