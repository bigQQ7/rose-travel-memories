...
export const tripDetails: { feeling: string[]; photos: GalleryItem[] }[] = [
  ...
  {feeling:['2024 年的一月，照片里是一望无际的雪，也是笑得很开心的我们。赛里木湖的冬天，就这样和你的样子一起留在了我的记忆里。','我很喜欢这张合照：不需要摆得多认真，只要两个人在一起，连冬日的画面都觉得暖了一点。希望很多年以后，我们还能记得当时的快乐。'],photos:[{image:'./assets/trip-4.png',label:'雪地里的我们'}]},
  {feeling:['一年以后，我们又一起回到了赛里木湖。看到相册里再次出现这个名字，觉得很奇妙：有些地方，因为一起去过，就会想再和同一个人回来。','这次的合照，也被认真收进了我们的旅行手记。想和你去新的地方，也想和你重走喜欢的路，让“我们一起”一直有下一页。'],photos:[{image:'./assets/trip-5.png',label:'再次和你来到这里'}]}
];
