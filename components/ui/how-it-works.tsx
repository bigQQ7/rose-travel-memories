    ...
    >
      <div className="bg-white dark:bg-neutral-900 p-2 rounded-[25px] shadow-[0px_10px_20px_0px_#D3D3D3] dark:shadow-none border border-neutral-100 dark:border-neutral-800">
        ...
        >
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-base/6 tracking-tight">
            {description}
          </p>
        </div>
      </div>
                ...
                {(() => {
                  ...
                  return (
                    <m.path
                      ...
                      animate={{
                        strokeDashoffset: reducedMotion ? 0 : -140, // Multiple of 14 (8+6) for seamless loop
                      }}
                      transition={{
                        duration: 3,
                        repeat: Infinity,
